...
const CreatePost = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if(form.prompt && form.photo){
            ...
            alert('Please Enter a Prompt and generate an umage')
        }
    };
            ...
            <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
                <div className="flex flex-col gap-5">
                    ...
                    <div className="relative bg-grey-50 border border-grey-300 text-grey-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center">
                        {form.photo ? (
                            <img src={form.photo} alt={form.prompt} className="w-full h-full object" />
                        ) : (
                ...
                <div className="mt-10">
                    ...
                    <button
                        type="submit"
                        className="mt-3 text-white bg-[#6469ff] font-medium rounded-md text-sm w-full sm:w-auto px-4 py-2.5 text-center"
                    >
